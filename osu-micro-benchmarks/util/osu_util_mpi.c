                        ...
                        enum accel_type type)
{
    ...
    for (i = 0; i < num_elements; i++) {
        ...
        /* @gkatev: Since floats are concerned, the result of this sum is not
         * always the same as the commented out multiplication below. A case
         * for the correct one could be made for both options. */
